...
@RestController
@CrossOrigin(origins = {"http://localhost:4200", "https://wcbdf-adl-eje-17-crud.vercel.app"}, methods = {RequestMethod.GET, RequestMethod.POST, RequestMethod.PUT, RequestMethod.DELETE})
